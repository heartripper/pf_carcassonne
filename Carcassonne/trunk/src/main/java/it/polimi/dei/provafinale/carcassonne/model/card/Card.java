...
public class Card {
	...
	public String getRepresentation() {
		...
		String northPlayer = getPlayerRep(SidePosition.N);
		String southSide = getSideRep(SidePosition.S);
		String southPlayer = getPlayerRep(SidePosition.S);
		String westSide = getSideRep(SidePosition.O);
		String westPlayer = getPlayerRep(SidePosition.O);
		String eastSide = getSideRep(SidePosition.E);
		String eastPlayer = getPlayerRep(SidePosition.E);
	...
	private String getPlayerRep(SidePosition pos) {
		Player p = getSide(pos).getPlayerCoin();
		if (p == null)
			return "";
		else
			return "," + p.getSymbol();
	...
	/**
	 * Rotate the card of 90� clock wise.
	 */
	public void rotate() {
		if (cardCoord != null) {
			return;
