...
public class TileGrid {
	 ...
	 *         it, false instead.
	 */
	public boolean hasCompatibleCoord(Card tile) {
	...
	public boolean putTile(Card tile, Coord coord) {
		...
		// its neighbors.
		tile.setLocationInfo(this, coord);
	 ...
	 * @param coord
	 *            - a Coord.
	 * @return true if the Tile is compatible with the given Coord, false instead.
	 */
	 ...
	 * 
	 * @return an array of String composing a placeholder for a cell with no neighbor Tiles.
	 */
	 ...
	 * @param coord
	 *            - a Coord.
	 * @return an array of lines composing the placeholder for a cell with neighbors Tiles.
	 */
